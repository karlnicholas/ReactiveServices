package com.github.karlnicholas.rs.accountservice.config;
...
public class ApplicationConfiguration extends AbstractR2dbcConfiguration {
	...
	public ConnectionFactory connectionFactory() {
		return ConnectionFactories.get("r2dbc:h2:mem:///accounts?options=DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
	}
}